...
type User struct {
	...
	Policy        string                 `protobuf:"bytes,2,opt,name=policy,proto3" json:"policy,omitempty"` // سیاست ترافیک (مثلاً "youtube")
...
func (x *InboundConfig) GetTls() *TLSSettings {
	if x != nil {
		return x.Tls
	}
	return nil
...
type TLSSettings struct {
	...
	EchKey        []byte                 `protobuf:"bytes,3,opt,name=ech_key,json=echKey,proto3" json:"ech_key,omitempty"`       // ECH KeySetList (binary)
	CertFile      string                 `protobuf:"bytes,4,opt,name=cert_file,json=certFile,proto3" json:"cert_file,omitempty"` // مسیر فایل گواهی
	KeyFile       string                 `protobuf:"bytes,5,opt,name=key_file,json=keyFile,proto3" json:"key_file,omitempty"`    // مسیر فایل کلید خصوصی
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TLSSettings) GetEchKey() []byte {
	if x != nil {
		return x.EchKey
	}
	return nil
...
func (x *TLSSettings) GetCertFile() string {
	if x != nil {
		return x.CertFile
	}
	return ""
...
func (x *OutboundConfig) GetTls() *TLSSettings {
	if x != nil {
		return x.Tls
	}
	return nil
...
const file_proxy_reflex_config_proto_rawDesc = "" +
	...
	"\x03tls\x18\x03 \x01(\v2\x19.reflex.proxy.TLSSettingsR\x03tls\"\x1e\n" +
	"\bFallback\x12\x12\n" +
	"\x04dest\x18\x01 \x01(\rR\x04dest\"\x99\x01\n" +
	"\vTLSSettings\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x1f\n" +
	"\vserver_name\x18\x02 \x01(\tR\n" +
	"serverName\x12\x17\n" +
	"\aech_key\x18\x03 \x01(\fR\x06echKey\x12\x1b\n" +
	"\tcert_file\x18\x04 \x01(\tR\bcertFile\x12\x19\n" +
	"\bkey_file\x18\x05 \x01(\tR\akeyFile\"{\n" +
	"\x0eOutboundConfig\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\tR\x02id\x12+\n" +
	"\x03tls\x18\x04 \x01(\v2\x19.reflex.proxy.TLSSettingsR\x03tlsB(Z&github.com/xtls/xray-core/proxy/reflexb\x06proto3"
...
var file_proxy_reflex_config_proto_goTypes = []any{
	...
	(*TLSSettings)(nil),    // 4: reflex.proxy.TLSSettings
	(*OutboundConfig)(nil), // 5: reflex.proxy.OutboundConfig
}
var file_proxy_reflex_config_proto_depIdxs = []int32{
	...
	4, // 2: reflex.proxy.InboundConfig.tls:type_name -> reflex.proxy.TLSSettings
	4, // 3: reflex.proxy.OutboundConfig.tls:type_name -> reflex.proxy.TLSSettings
