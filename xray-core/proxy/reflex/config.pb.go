...
type InboundConfig struct {
	...
	UseQuic       bool                   `protobuf:"varint,4,opt,name=use_quic,json=useQuic,proto3" json:"use_quic,omitempty"`
	ServerName    string                 `protobuf:"bytes,5,opt,name=server_name,json=serverName,proto3" json:"server_name,omitempty"` // For TLS SNI
	EchConfig     []byte                 `protobuf:"bytes,6,opt,name=ech_config,json=echConfig,proto3" json:"ech_config,omitempty"`    // ECH Config bytes (optional)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InboundConfig) GetUseTls() bool {
	if x != nil {
		return x.UseTls
	}
	return false
...
func (x *InboundConfig) GetUseQuic() bool {
	if x != nil {
		return x.UseQuic
	}
	return false
...
func (x *InboundConfig) GetServerName() string {
	if x != nil {
		return x.ServerName
	}
	return ""
...
func (x *InboundConfig) GetEchConfig() []byte {
	if x != nil {
		return x.EchConfig
	}
	return nil
...
const file_proxy_reflex_config_proto_rawDesc = "" +
	...
	"\bfallback\x18\x02 \x01(\v2\x16.reflex.proxy.FallbackR\bfallback\x12\x17\n" +
	"\ause_tls\x18\x03 \x01(\bR\x06useTls\x12\x19\n" +
	"\buse_quic\x18\x04 \x01(\bR\auseQuic\x12\x1f\n" +
	"\vserver_name\x18\x05 \x01(\tR\n" +
	"serverName\x12\x1d\n" +
	"\n" +
	"ech_config\x18\x06 \x01(\fR\techConfig\"\x1e\n" +
	"\bFallback\x12\x12\n" +
