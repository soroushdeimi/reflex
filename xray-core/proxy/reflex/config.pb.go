...
const file_proxy_reflex_config_proto_rawDesc = "" +
	...
	"\bfallback\x18\x02 \x01(\v2\x1b.xray.proxy.reflex.FallbackR\bfallback\"\x1e\n" +
	"\bFallback\x12\x12\n" +
...
var file_proxy_reflex_config_proto_goTypes = []any{
	...
	(*InboundConfig)(nil),  // 2: xray.proxy.reflex.InboundConfig
	(*Fallback)(nil),       // 3: xray.proxy.reflex.Fallback
...
var file_proxy_reflex_config_proto_depIdxs = []int32{
	...
	3, // 1: xray.proxy.reflex.InboundConfig.fallback:type_name -> xray.proxy.reflex.Fallback
