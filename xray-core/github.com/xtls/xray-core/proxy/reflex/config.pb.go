...
// User: client definition in config JSON
type User struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`         // UUID of the user
	Policy        string                 `protobuf:"bytes,2,opt,name=policy,proto3" json:"policy,omitempty"` // policy string
...
const file_proxy_reflex_config_proto_rawDesc = "" +
	...
	"\bFallback\x12\x12\n" +
	"\x04dest\x18\x01 \x01(\rR\x04dest\"e\n" +
	"\rInboundConfig\x12&\n" +
	"\aclients\x18\x01 \x03(\v2\f.reflex.UserR\aclients\x12,\n" +
	"\bfallback\x18\x02 \x01(\v2\x10.reflex.FallbackR\bfallback\"N\n" +
	"\x0eOutboundConfig\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\tR\x02idB/Z-github.com/xtls/xray-core/proxy/reflex;reflexb\x06proto3"
...
var file_proxy_reflex_config_proto_goTypes = []any{
	...
	(*Fallback)(nil),       // 2: reflex.Fallback
	(*InboundConfig)(nil),  // 3: reflex.InboundConfig
...
var file_proxy_reflex_config_proto_depIdxs = []int32{
	...
	2, // 1: reflex.InboundConfig.fallback:type_name -> reflex.Fallback
